export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
   APP_ID: "wx7ca23e3961d06c29",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
   APP_SECRET: "7a05abe3271c7df2752df10197150dfa",
  ...
  USERS: [
    {
      ...
      name: "宝宝",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oipbO6ncy9OYFbfptGzP04NE19Fg",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "BOOKx5ea0jJnGZkl8YnTwOExkW_h4Tmbf5rsW0v_ONE",
      // 所在省份
      province: "河南",
  ...
  CALLBACK_TEMPLATE_ID: "gUgOehteTJHbMeYbyazMtynb5up4iWfYfC878ZiSQYw",
  ...
  CUSTOMIZED_DATE_LIST: [
    ...
    // 宝宝生日
    {"keyword": "marry_day", date: "2022-04-20"},
    // sakana日
